...
#include "RNSrSlipUFvPatchVectorField.H"
...
Foam::RNSrSlipUFvPatchVectorField::RNSrSlipUFvPatchVectorField
(
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF
)
:
    RNSmfvSlipFvPatchVectorField(p, iF),
    TName_("T"),
    rhoName_("rho"),
    psiName_("thermo:psi"),
    muName_("thermo:mu"),
...
Foam::RNSrSlipUFvPatchVectorField::RNSrSlipUFvPatchVectorField
(
    const RNSrSlipUFvPatchVectorField& mspvf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
    const fvPatchFieldMapper& mapper
)
:
    RNSmfvSlipFvPatchVectorField(mspvf, p, iF, mapper),
    TName_(mspvf.TName_),
...
:
    RNSmfvSlipFvPatchVectorField(mspvf, iF),
    TName_(mspvf.TName_),
    rhoName_(mspvf.rhoName_),
    psiName_(mspvf.psiName_),
    muName_(mspvf.muName_),
...
void Foam::RNSrSlipUFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
	...
	("transportProperties");
	scalar alpha = readScalar(transportProperties.lookup("alpha"));
	Field<scalar> Km(alpha*pmu/prho);
    ...
    RNSmfvSlipFvPatchVectorField::updateCoeffs();
}


void Foam::RNSrSlipUFvPatchVectorField::write(Ostream& os) const
{
