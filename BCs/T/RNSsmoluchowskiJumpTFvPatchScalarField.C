...
#include "RNSsmoluchowskiJumpTFvPatchScalarField.H"
...
Foam::RNSsmoluchowskiJumpTFvPatchScalarField::RNSsmoluchowskiJumpTFvPatchScalarField
(
    const fvPatch& p,
...
Foam::RNSsmoluchowskiJumpTFvPatchScalarField::RNSsmoluchowskiJumpTFvPatchScalarField
(
    const RNSsmoluchowskiJumpTFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::RNSsmoluchowskiJumpTFvPatchScalarField::RNSsmoluchowskiJumpTFvPatchScalarField
(
    const RNSsmoluchowskiJumpTFvPatchScalarField& ptpsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
// Map from self
void Foam::RNSsmoluchowskiJumpTFvPatchScalarField::autoMap
(
...
void Foam::RNSsmoluchowskiJumpTFvPatchScalarField::rmap
(
...
void Foam::RNSsmoluchowskiJumpTFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void Foam::RNSsmoluchowskiJumpTFvPatchScalarField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchScalarField,
        RNSsmoluchowskiJumpTFvPatchScalarField
    );
}
